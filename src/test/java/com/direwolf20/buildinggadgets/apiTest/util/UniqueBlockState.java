 ...
 * </p>
 */
public class UniqueBlockState extends BlockState {
    ...
    private UniqueBlockState(int id) {
        // fixme: this is wrong. it's to stop the test messing up.
        //        we're yet to rebuild this class properly.
        super(Blocks.AIR, ImmutableMap.of());
        this.id = id;
    }
    ...
    @Override
    public boolean canEntitySpawn(IBlockReader block, BlockPos pos, EntityType<?> entityType) {
        return false;
    }
    ...
    @Override
    public int getPackedLightmapCoords(IEnviromentBlockReader source, BlockPos pos) {
        return 0;
    }

    @Override
    public int getLightValue(IEnviromentBlockReader world, BlockPos pos) {
        return 0;
    }
    ...
    @Override
    public void neighborChanged(World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos, boolean p_215697_5_) {
    ...
    @Override
    public void onBlockAdded(World worldIn, BlockPos pos, BlockState oldState, boolean p_215705_4_) {
