...
public class RegionIteratorTest {
    ...
    @Test
    public void iteratorShouldStartGoInAccentingOrderWhereZFirstYSecondXThirdAllPositiveCaseHardcoded() {
    ...
    @Test
    public void iteratorShouldStartGoInAccentingOrderWhereZFirstYSecondXThirdAllNegativeCaseHardcoded() {
