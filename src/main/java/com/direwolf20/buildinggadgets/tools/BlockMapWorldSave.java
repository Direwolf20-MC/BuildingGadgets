...
public class BlockMapWorldSave extends WorldSavedData {
    private static final String DATA_NAME = MODID + "_BlockMapData";
    private static final String TAGNAME = "tagmap";

    private Map<String, NBTTagCompound> tagMap = new HashMap<String, NBTTagCompound>();
    //private NBTTagList mapTag;

    public BlockMapWorldSave() {
        super(DATA_NAME);
    }

    public BlockMapWorldSave(String s) {
        super(s);
    }
    ...
    public static BlockMapWorldSave get(World world) {
        MapStorage storage = world.getMapStorage();
        BlockMapWorldSave instance = (BlockMapWorldSave) storage.getOrLoadData(BlockMapWorldSave.class, DATA_NAME);

        if (instance == null) {
            instance = new BlockMapWorldSave();
