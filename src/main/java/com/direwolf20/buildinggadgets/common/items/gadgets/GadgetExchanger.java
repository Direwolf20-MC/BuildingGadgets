...
public class GadgetExchanger extends GadgetGeneric {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        if (!world.isRemote) {
            if (player.isSneaking()) {
                ...
                IEnergyStorage energy = CapabilityUtil.EnergyUtil.getCap(itemstack).orElseThrow(NullPointerException::new);
    ...
    private boolean exchange(EntityPlayer player, ItemStack stack) {
        ...
        LiquidInteractions.GadgetGeneric fluidPlacementMode = getFluidInteractionMode(stack);
