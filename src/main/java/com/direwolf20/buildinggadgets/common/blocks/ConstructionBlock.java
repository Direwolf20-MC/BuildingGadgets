...
public class ConstructionBlock extends Block /*implements IFacade*/ {
    ...
    public boolean addHitEffects(BlockState state, World world, RayTraceResult target, ParticleManager manager) {
        ...
        this.addBlockHitEffects(world, pos, tileEntity.getBlockState(), ((BlockRayTraceResult) target).getDirection(), manager);
        return true;
    }
    ...
    public void addBlockHitEffects(World world, BlockPos pos, BlockState blockstate, Direction side, ParticleManager manager) {
        if (blockstate.getRenderShape() == BlockRenderType.INVISIBLE) return;
        ...
        manager.add((new DiggingParticle((ClientWorld) world, x, y, z, 0.0D, 0.0D, 0.0D, blockstate)).init(pos).setPower(0.2F).scale(0.6F));
    }
...
//    }
    ...
    public VoxelShape getCollisionShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext selectionContext) {
        ...
        return !isMimicNull(mimic) ? mimic.getBlockSupportShape(worldIn, pos) : super.getCollisionShape(state, worldIn, pos, selectionContext);
    }
...
//    }
    ...
    public VoxelShape getOcclusionShape(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return !isMimicNull(mimic) ? mimic.getOcclusionShape(worldIn, pos) : super.getOcclusionShape(state, worldIn, pos);
    }
    ...
    public VoxelShape getInteractionShape(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return !isMimicNull(mimic) ? mimic.getVisualShape(worldIn, pos, ISelectionContext.empty()) : super.getInteractionShape(state, worldIn, pos);
    }
