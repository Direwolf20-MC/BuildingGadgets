...
public final class OurItems {
    ...
    public static void setup() {
        ...
        itemBuilders.addAll(new HashSet<Builder>() {{
            ...
            add(new Builder(ItemReference.GADGET_COPY_PASTE_RL).setBuilder(nonStackableItemProperties().maxDamage(1)).setFactory(GadgetCopyPaste::new));
            add(new Builder(ItemReference.GADGET_DESTRUCTION_RL).setBuilder(nonStackableItemProperties().maxDamage(1)).setFactory(GadgetDestruction::new));
