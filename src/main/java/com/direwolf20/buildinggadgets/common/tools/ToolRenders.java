...
//                ItemStack itemStack;
//                if (renderBlockState.getBlock().canSilkHarvest(world, BlockPos.ORIGIN, renderBlockState, player)) {
//                    itemStack = InventoryManipulation.getSilkTouchDrop(renderBlockState);
//                } else {
//                    itemStack = renderBlockState.getBlock().getPickBlock(renderBlockState, null, world, BlockPos.ORIGIN, player);
//                }
...
//
//                //Figure out how many of the block we're rendering we have in the inventory of the player.
//                //ItemStack itemStack = renderBlockState.getBlock().getPickBlock(renderBlockState, null, world, BlockPos.ORIGIN, player);
...
//        mc.renderEngine.bindTexture(TextureMap.LOCATION_BLOCKS_TEXTURE);
//
//        List<BlockPos> coordinates = GadgetDestruction.getArea(world, startBlock, facing, player, heldItem);
//
//        //Prepare the block rendering
//        BlockRenderLayer origLayer = MinecraftForgeClient.getRenderLayer();
//
