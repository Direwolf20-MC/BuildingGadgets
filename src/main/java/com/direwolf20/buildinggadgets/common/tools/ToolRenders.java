...
//                    coordinates = BuildingModes.getBuildOrders(world, player, lookingAt.getBlockPos(), lookingAt.sideHit, heldItem);
                    coordinates = BuildingGadgetModes.VERTICAL_COLUMN.getMode().getCollection(player, world, renderBlockState, lookingAt.getBlockPos(), player.getPosition(), lookingAt.sideHit, getToolRange(heldItem), GadgetBuilding.shouldPlaceAtop(heldItem), GadgetBuilding.getFuzzy(heldItem));
