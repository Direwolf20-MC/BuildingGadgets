...
public final class Styles {
    ...
    public static final Style DK_GREEN = new Style().setColor(TextFormatting.DARK_GREEN);
    public static final Style AQUA = new Style().setColor(TextFormatting.AQUA);
    public static final Style LT_PURPLE = new Style().setColor(TextFormatting.LIGHT_PURPLE);
