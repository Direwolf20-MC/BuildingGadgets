...
@Mod(modid = BuildingGadgets.MODID, name = BuildingGadgets.MODNAME,
        //dependencies =
        //        "required-after:botania;required-after:baubles;",

        version = BuildingGadgets.VERSION, useMetadata = true)
